...
class CurriculumDetails(db.Model):
    ...
    __table_args__ = (db.PrimaryKeyConstraint('curriculum_id', 'curriculum_year',
...
class Prerequisite(db.Model):
    ...
    __table_args__ = (db.PrimaryKeyConstraint('subjcode', 'prereq', name='subjcode_prereq_pk'),)
    subjcode = db.Column(db.CHAR(12), nullable=False)
...
class Registration(db.Model):
    ...
    __table_args__ = (db.PrimaryKeyConstraint('sy', 'sem', 'studid', 'subjcode', name='registration_pkey'),
                      db.ForeignKeyConstraint(['sy', 'sem', 'section', 'subjcode'], ['semsubject.sy', 'semsubject.sem', 'semsubject.section',
